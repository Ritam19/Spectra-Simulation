...
#a)	If the parameter exists in the inp.py file, the value is used for all the excitation energies.												#
#b)	If the parameter does not exist in the file, the default value is used.															#
#																								#
#																								#
#For gamma:																							#
#a)	If the parameter exists and the value > 0, this value is used for all the bands														#
#b)	If the parameter exists and the value = 0, gamma should be read from a “gamma.dat” file where it contains a list of values coresponding to each excitation energy.		    	#
#																								#
#																								#
#For delta:																							#
#a)	If the parameter exists and the value > or = 0, this value is used for all the bands													#
#b)	If the parameter exists and the value = -1, delta should be read from a “delta.dat” file where it contains a list of values coresponding to each excitation energy.		    	#
#																								#
#																								#
